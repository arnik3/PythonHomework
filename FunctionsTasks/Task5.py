...
def main():
    while True:
        student_name = input("Введите имя студента (или введите 'стоп' для завершения): ")
        ...
        for i in range(num_subjects):
            score = int(input(f"Введите баллы по предмету {i + 1} (от 0 до 50): "))
            total_score += score
        print(f"Итоговый счёт: {total_score}")
        print(calculate_grade(total_score))
